  ...
  const projects = [
    {
      ...
      technologies: 'Python, Airflow, dbt, BigQuery',
      image: '/images/project1.png',
      description: 'A scalable data pipeline for real-time analytics.',
      order: 1,
    },
    {
      title: 'Project Two',
      ...
      description: 'A full-stack web application for data visualization.',
      order: 2,
    },
  ]
  ...
  const experiences = [
    {
      ...
      responsibilities: [
        'Designing ETL pipelines with Airflow and dbt',
        'Managing data warehouse on BigQuery',
